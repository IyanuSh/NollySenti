...
do	  
	...
	export SEED=$j
	export LANG=yo
	export DATA_DIR=data/nolly400_${LANG}
	
	
	export BERT_MODEL=xlm-roberta-base
	export OUTPUT_DIR=${LANG}_xlmrbase400
	...
	export OUTPUT_DIR=${LANG}_mdeberta400
	...
	export OUTPUT_DIR=${LANG}_afroxlmrbase400
	...
	export OUTPUT_DIR=${LANG}_bert400
	...
	export OUTPUT_DIR=${LANG}_afriberta400
